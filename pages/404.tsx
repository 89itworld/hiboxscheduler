  ...
  /* const links = [
    {
      ...
      href: "https://docs.hiboxscheduler.com",
    },
    {
      title: t("api_reference"),
      description: t("api_reference_description"),
      icon: CodeIcon,
      href: "https://api.docs.hiboxscheduler.com",
    },
    {
      title: t("blog"),
      description: t("blog_description"),
      icon: BookOpenIcon,
      href: "https://hiboxscheduler.com/blog",
    },
  ]; */
        ...
        <main className="max-w-xl pt-16 pb-6 mx-auto sm:pt-24">
          <div className="text-center">
            ...
            {isEventType404 ? (
              ...
              <a href={`${NEXT_PUBLIC_APP_URL}/auth/signup`} className="inline-block mt-2 text-lg ">
                {/* {t("the_username")} <strong className="text-blue-500">{username}</strong>{" "}
            ...
            {!isEventType404 && (
              <ul role="list" className="mt-4">
                <li className="px-4 py-2 border-2 border-green-500">
                  <a
                    href="https://scheduler.hibox.co/auth/signup"
