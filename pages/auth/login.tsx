...
export default function Login({ csrfToken }) {
  ...
  const errorMessages: { [key: string]: string } = {
    ...
    [ErrorCode.EmailNotVerified]: `Login Failed. Email is not verified. We have sent a verification link on your email address.`,
  };
  ...
  return (
    <div className="flex flex-col justify-center min-h-screen py-12 bg-neutral-50 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <img className="mx-auto mt-6" src="/Hibox-Scheduler-logo-white-word.svg" alt="Hibox Scheduler Logo" />
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <button
                ...
                className="flex justify-center w-full px-4 py-2 text-sm font-medium text-white border border-transparent rounded-sm shadow-sm bg-hiboxBlue-900 hover:bg-hiboxBlue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black">
                {t("sign_in")}
              </button>
            </div>
        ...
        <div className="mt-4 text-sm text-center text-neutral-600">
          ...
          <a
            href={`${NEXT_PUBLIC_APP_URL}/auth/signup`}
