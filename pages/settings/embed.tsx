        ...
        {!editWebhookEnabled && (
          <div className="py-6 lg:pb-8 lg:col-span-9">
            ...
            <div className="flex justify-between my-6">
              ...
              <div>
                <Dialog>
                  <DialogTrigger className="px-4 py-2 my-6 text-sm font-medium text-white border border-transparent rounded-sm shadow-sm bg-hiboxBlue-900 hover:bg-hiboxBlue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-900">
            ...
            {/*  <hr className="mt-8" />
            <div className="my-6">
              <h2 className="text-lg font-medium leading-6 text-gray-900 font-cal">Hibox Scheduler API</h2>
