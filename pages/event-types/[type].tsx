...
const EventTypePage = (props: inferSSRProps<typeof getServerSideProps>) => {
  ...
  const { eventType, locationOptions: locationOptionsProps = {}, availability, team, teamMembers, hasPaymentIntegration, currency } =
    props;
  const locationOptions = JSON.parse(JSON.stringify(locationOptionsProps));
