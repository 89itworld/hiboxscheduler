        ...
        <div className="p-2 rounded-lg shadow-lg sm:p-3" style={{ background: "#2F333D" }}>
          <div className="flex flex-wrap items-center justify-between">
            <div className="flex items-center flex-1 w-0">
              <span className="flex p-2 bg-black rounded-lg bg-opacity-30">
                <svg
            ...
            <div className="flex-shrink-0 order-2 sm:order-3 sm:ml-2">
              <button
                ...
                type="button"
                className="flex p-2 -mr-1 rounded-md bg-hiboxBlue-900 hover:bg-hiboxBlue-700 focus:outline-none focus:ring-2 focus:ring-white">
