        ...
        {days.map((day, idx) =>
          activeDays[idx] ? (
            <button
              ...
              className={`
              w-10 h-10
              bg-hiboxBlue-900 text-white focus:outline-none px-3 py-1 rounded 
            ...
            <button
              ...
              className={`w-10 h-10 bg-gray-50 focus:outline-none px-3 py-1 rounded-none ${idx === 0 ? "rounded-l" : "border-l-0"
                } ${idx === days.length - 1 ? "rounded-r" : ""}`}>
              {day}
            </button>
          )
