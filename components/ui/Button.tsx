    ...
    elementType,
    {
      ...
      className: classNames(
        ...
        (disabled
          ...
          : "border border-transparent dark:text-black text-white bg-hiboxBlue-900 hover:bg-hiboxBlue-700 dark:bg-white hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-neutral-900"),
        color === "secondary" &&
        (disabled
