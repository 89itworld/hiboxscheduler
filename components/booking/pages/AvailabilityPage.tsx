...
import GetFreeSchedulerLogo from "@components/ui/GetFreeSchedulerLogo";
import TextOverFlowHandler from "@components/TextOverFlowHandler/TextOverFlowHandler";
            ...
            <div className="bg-white border-gray-200 rounded-sm sm:dark:border-gray-600 dark:bg-gray-900 md:border">
              ...
              <div className="px-4 sm:flex sm:py-5 sm:p-4">
                <div
                  ...
                  <TimezoneDropdown />
                  <p data-tooltip-target="tooltip-default"  className="mt-3 mb-8 text-gray-600 dark:text-gray-200">
                    {eventType.description && <TextOverFlowHandler text={eventType.description}/>}
                  </p>
                  ...
                  {/*className={`relative ${selectedDate ? "top-16" : "top-24"} `}*/}
                  <div className="getSchedulerHiBoxLogo">
                    <a href={`https://www.hiboxscheduler.com/`} target="_blank">
                      <GetFreeSchedulerLogo />
                    </a>
                  </div>
                </div>
                <DatePicker
