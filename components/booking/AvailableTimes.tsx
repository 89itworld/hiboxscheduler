            ...
            return (
              <div key={slot.time.format()}>
                <Link href={bookingUrl}>
                  <a
                    className="block py-4 mb-2 font-medium bg-white border rounded-sm dark:bg-gray-600 text-hiboxBlue-900 dark:text-neutral-200 border-hiboxBlue-900 dark:border-transparent hover:text-white hover:bg-hiboxBlue-700 dark:hover:border-black dark:hover:bg-hiboxBlue-700"
                    data-testid="time">
